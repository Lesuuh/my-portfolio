...
export const Contact = () => {
  ...
  return (
    <div className="ralewayfont bg-white w-full h-full rounded-xl px-5 md:px-16 py-5">
      <h1 className="font-medium text-3xl poppinsfont">Contact</h1>
      <div className="grid grid-cols mt-5 gap-5 lg:grid-cols-2">
        <div className=" poppinsfont bg-cardBg px-3 py-8 rounded-xl gap-3 flex flex-row items-start ">
        ...
        <div className=" poppinsfont bg-buttonsBg px-3 py-8 gap-3 rounded-xl flex flex-row items-start ">
      ...
      <div className="mt-10 bg-skillsBg px-5 rounded-xl py-5">
        <p>
